export function summarizeCycle(report) {
  ...
  return { listCount: report.listCount || 0, reviewed: (report.jobReviews || []).length,
    ...
    inbox: report.inboxSummary || {}, inboxFailures:report.inboxFailures||[], inboxDiscovery: report.inboxDiscovery || {}, reconciliation: report.reconciliation || {}, contactRecovery: report.contactRecovery || {}, contactFailures: report.contactFailures || [], modelDeferredUntil:report.modelDeferredUntil || null };
}
