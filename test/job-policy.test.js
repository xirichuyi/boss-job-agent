...
const base = { location: '杭州', salary: '11-20K', scaleEvidence: '500+', title: 'AI工程师', requirements: ['本科', '在校/应届'] };
test('education, experience and graduation do not reject; internships are excluded', () => {
  ...
  assert.equal(hardReject({ ...base, title: '产品实习生', requirements: ['博士', '10年以上', '5天/周'] }), '排除实习岗位');
